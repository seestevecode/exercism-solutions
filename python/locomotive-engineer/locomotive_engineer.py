...
def fix_list_of_wagons(each_wagons_id, missing_wagons):
    ...
    """
    [move_wagon1, move_wagon2, locomotive, *other_wagons] = each_wagons_id
    return [locomotive, *missing_wagons, *other_wagons, move_wagon1, move_wagon2]
...
def add_missing_stops(route, **missing_stops):
    ...
    """
    return {**route, "stops": list(missing_stops.values())}
