...
def check_drinks(drink_name, drink_ingredients):
    ...
    return drink_name + ' ' + ('Mocktail' if ALCOHOLS.isdisjoint(drink_ingredients) else 'Cocktail')
...
def categorize_dish(dish_name, dish_ingredients):
    ...
    category = (
        'VEGAN' if VEGAN.issuperset(dish_ingredients) else
        'VEGETARIAN' if VEGETARIAN.issuperset(dish_ingredients) else
        'PALEO' if PALEO.issuperset(dish_ingredients) else
        'KETO' if KETO.issuperset(dish_ingredients) else
        'OMNIVORE' if OMNIVORE.issuperset(dish_ingredients) else
        'MIXED'
    )
